package com.example.recipe_app_1.Adapters;
...
import com.example.recipe_app_1.Models.Recipe;
import com.example.recipe_app_1.R;
...
public class RandomRecipeAdapter extends RecyclerView.Adapter<RandomRecipeViewHolder>{
    ...
    public void onBindViewHolder(@NonNull RandomRecipeViewHolder holder, int position) {
        ...
        holder.textView_title.setText(list.get(position).aggregateLikes + " Likes ");
