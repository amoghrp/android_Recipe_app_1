...
import com.example.recipe_app_1.Models.InstructionsResponse;
...
public class RequestManager {
    ...
    public void getRandomRecipes(RandomRecipeResponseListener listener, List<String> tags ){
        ...
        Call<RandomRecipeApiResponse> call = callRandomRecipes.callRandomRecipe(context.getString(R.string.api_key), "10" , tags);/*here we can pass anything between 1 and 100*/
